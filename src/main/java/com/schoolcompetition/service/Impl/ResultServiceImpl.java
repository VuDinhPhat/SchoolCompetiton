...
public class ResultServiceImpl implements ResultService {
    ...
    public ResponseEntity<ResponseObj> getListResults(int page, int size) {
        try {
            ...
            // Truy vấn dữ liệu Result từ cơ sở dữ liệu sử dụng phân trang
            ...
            if (resultPage.hasContent()) {
                ...
                // Chuyển đổi danh sách Result thành danh sách ResultResponse
                for (Result result : resultPage.getContent()) {
                    resultResponses.add(ResultMapper.toResultResponse(result));
                }

                // Tạo đối tượng ResponseObj chứa danh sách ResultResponse
